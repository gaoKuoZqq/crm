...
<script type="text/javascript">
	$(function(){
		/*展示数据的datagrid表格*/
		$("#datagrid").datagrid({
			url:'${ctx}/saleChance/find.do?status=1',//只查询已分配咨询师的
			method:'get',
			fit:true,
			singleSelect:false,
			toolbar:'#toolbar',
	...
	function openCusDevPlanTab(id){
		 window.parent.openTab('客户开发计划项管理','${ctx}/cusDevPlan/index.do?saleChanceId='+id,'icon-khkfjh');
	}
	 
	//只能查看开发信息
	function openCusDevPlanInfoTab(id){
		window.parent.openTab('查看客户开发计划项','${ctx}/cusDevPlan/index.do?saleChanceId='+id+'&show=true','icon-khkfjh');
	}
	...
	<div id="dialog" style="width:650;height:280,padding: 10px 20px">
		<form action="" id="form" method="post">
			...
			<table cellspacing="8px">
		   		...
		   		<tr>
		   			<td>指派给：</td>
		   			<td><input class="easyui-combobox" id="assignMan" name="assignMan" data-options="panelHeight:'auto',editable:false,valueField:'trueName',textField:'trueName',url:'${ctx}/user/getCustomerManagerList.do'"/></td>
		   			<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
		   			<td>指派时间：</td>
